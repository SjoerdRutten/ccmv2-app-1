    ...
    public function handle(): void
    {
        ...
        if ($crmCard = \DB::connection('db01')
            ...
            $this->environment->crmCards()->updateOrCreate([
                ...
                'first_email_send_at' => empty($crmCard->eerste_email) ? null : Carbon::parse($crmCard->eerste_email)->timezone('Europe/Amsterdam'),
                'latest_email_send_at' => empty($crmCard->laatste_email) ? null : Carbon::parse($crmCard->laatste_email)->timezone('Europe/Amsterdam'),
                'first_email_opened_at' => empty($crmCard->eerste_email_geopend) ? null : Carbon::parse($crmCard->eerste_email_geopend)->timezone('Europe/Amsterdam'),
                'latest_email_opened_at' => empty($crmCard->laatste_email_geopend) ? null : Carbon::parse($crmCard->laatste_email_geopend)->timezone('Europe/Amsterdam'),
                'first_email_clicked_at' => empty($crmCard->eerste_email_geklikt) ? null : Carbon::parse($crmCard->eerste_email_geklikt)->timezone('Europe/Amsterdam'),
                'latest_email_clicked_at' => empty($crmCard->laatste_email_geklikt) ? null : Carbon::parse($crmCard->laatste_email_geklikt)->timezone('Europe/Amsterdam'),
                'first_visit_at' => empty($crmCard->eerste_bezoek) ? null : Carbon::parse($crmCard->eerste_bezoek)->timezone('Europe/Amsterdam'),
                'latest_visit_at' => empty($crmCard->laatste_bezoek) ? null : Carbon::parse($crmCard->laatste_bezoek)->timezone('Europe/Amsterdam'),
