    ...
    public function handle(): void
    {
        ...
        try {
            $this->environment->crmCards()->updateOrCreate([
                ...
                'first_email_send_at' => Carbon::parse($crmCard->eerste_email),
                'latest_email_send_at' => Carbon::parse($crmCard->laatste_email),
                'first_email_opened_at' => Carbon::parse($crmCard->eerste_email_geopend),
                'latest_email_opened_at' => Carbon::parse($crmCard->laatste_email_geopend),
                'first_email_clicked_at' => Carbon::parse($crmCard->eerste_email_geklikt),
                'latest_email_clicked_at' => Carbon::parse($crmCard->laatste_email_geklikt),
                'first_visit_at' => Carbon::parse($crmCard->eerste_bezoek),
                'latest_visit_at' => Carbon::parse($crmCard->laatste_bezoek),
                ...
                'data' => $data,
                'created_at' => Carbon::parse($crmCard->datumcreatie),
                'updated_at' => Carbon::parse($crmCard->datummutatie),
            ]);
        } catch (\Exception $e) {
            \DB::rollBack();
        }
