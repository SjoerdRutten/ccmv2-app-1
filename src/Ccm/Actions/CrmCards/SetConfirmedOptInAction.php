...
class SetConfirmedOptInAction extends CcmAction
{
    public string $name = 'Set opt-in en confirmed opt-in voor opgegeven veld';
    ...
    public function handle(): void
    {
        $this->crmCard->setData([
            ...
            '_'.$this->crmField->name.'_confirmed_optin' => 1,
            '_'.$this->crmField->name.'_confirmed_optin_timestamp' => now(),
